...
#include <time.h>
    ...
    int partition(tlist* arr, int low, int high){ // funcao para achar o pivo da array
    ...
    void quickSort(tlist* arr, int low, int high) { // funcao quicksort
        if (low<high){
    ...
    int main(){
        ...
        printf("Lista Ordenada pelo QuickSort:  \n");
        quickSort(arr2,0, arrsize-1); // aqui acontece a ordenação
